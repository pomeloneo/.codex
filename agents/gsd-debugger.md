...
<required_reading>
@$HOME/.codex/gsd-core/references/common-bug-patterns.md
</required_reading>
...
@$HOME/.codex/gsd-core/references/debugger-philosophy.md
...
Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = $HOME/.codex/gsd-core
                  → writes to $HOME/.codex/gsd-core/hooks/
...
@$HOME/.codex/gsd-core/references/thinking-models-debug.md
...
- Read @$HOME/.codex/gsd-core/references/common-bug-patterns.md
