...
<reference>
@$HOME/.codex/gsd-core/references/user-profiling.md
...
Read the user-profiling reference document at `$HOME/.codex/gsd-core/references/user-profiling.md` to load:
