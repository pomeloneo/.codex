---
name: obsidian-vault
description: Search, capture, edit, and organize the user's Obsidian knowledge base across work and personal machines. Use when the user asks Codex to record useful conversation findings into Obsidian, preserve project/repository exploration notes, create business-learning reports, capture general durable knowledge, save key Q&A, search the user's personal note context, maintain wikilinks/backlinks/index notes, or make explicit Obsidian vault/config changes.
---
