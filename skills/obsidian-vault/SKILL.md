...
- Callout density rule: never leave a callout as one oversized paragraph when it contains multiple files, rules, examples, or tradeoffs. Rewrite it as a short lead sentence plus separated bullet groups.
