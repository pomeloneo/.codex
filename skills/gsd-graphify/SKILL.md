...
```bash
node $HOME/.codex/gsd-core/bin/gsd-tools.cjs graphify query <term>
```
...
```bash
node $HOME/.codex/gsd-core/bin/gsd-tools.cjs graphify diff
```
...
```bash
node "$HOME/.codex/gsd-core/bin/gsd-tools.cjs" graphify build
```
...
graphify update . \
  ...
  && node "$HOME/.codex/gsd-core/bin/gsd-tools.cjs" graphify build snapshot \
  && node "$HOME/.codex/gsd-core/bin/gsd-tools.cjs" graphify status
```
