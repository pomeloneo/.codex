...
| `llm_model` | str | `None` | Model name (e.g., "openai/gpt-4o-mini") for image descriptions |
...
md = MarkItDown(
    llm_client=client,
    llm_model="openai/gpt-4o-mini",  # example vision model
...
- `openai/gpt-4o-mini` - **Recommended for scientific vision**
