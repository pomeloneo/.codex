...
Translated from `/Users/bytedance/.claude/agents/docs-lookup.md` on 2026-04-23.
Source model: `sonnet` -> Codex model: `gpt-5.4` with reasoning effort `medium`.
Source Claude tools: `Read`, `Grep`, `mcp__context7__resolve-library-id`, `mcp__context7__query-docs`.
...
- Prefer official docs or configured MCP servers when external verification is needed.
