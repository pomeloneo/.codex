...
Translated from `/Users/bytedance/.claude/agents/a11y-architect.md` on 2026-04-23.
Source model: `opus` -> Codex model: `gpt-5.4` with reasoning effort `high`.
Source Claude tools: `Read`, `Write`, `Edit`, `Bash`, `Grep`, `Glob`.
Source frontmatter had duplicate `model` keys; the last value won during translation: sonnet -> opus.
