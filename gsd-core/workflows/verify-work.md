...
**MVP-mode UAT framing.** When `MVP_MODE=true`, follow the rules in `@$HOME/.codex/gsd-core/references/verify-mvp-mode.md`. Briefly:
...
Read and follow `$HOME/.codex/gsd-core/workflows/transition.md`.
...
- Follow @$HOME/.codex/gsd-core/workflows/diagnose-issues.md
