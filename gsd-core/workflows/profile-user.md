...
Key references:
- @$HOME/.codex/gsd-core/references/ui-brand.md (display patterns)
- @$HOME/.codex/agents/gsd-user-profiler.md (profiler agent definition)
- @$HOME/.codex/gsd-core/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="$HOME/.codex/gsd-core/USER-PROFILE.md"
...
```bash
cp "$HOME/.codex/gsd-core/USER-PROFILE.md" "$HOME/.codex/USER-PROFILE.backup.md"
```
...
✓ Stores profile at $HOME/.codex/gsd-core/USER-PROFILE.md
...
- The user-profiling reference doc at `$HOME/.codex/gsd-core/references/user-profiling.md`
...
Reference: @$HOME/.codex/gsd-core/references/user-profiling.md
...
Display: "✓ Profile written to $HOME/.codex/gsd-core/USER-PROFILE.md"
...
**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at $HOME/.codex/gsd-core/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated $gsd-dev-preferences at $HOME/.codex/skills/gsd-dev-preferences/SKILL.md"
...
Display: "✓ Added profile section to $HOME/.codex/AGENTS.md"
...
Your profile:    $HOME/.codex/gsd-core/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ $gsd-dev-preferences   $HOME/.codex/skills/gsd-dev-preferences/SKILL.md
  ✓ AGENTS.md section       ./AGENTS.md
  ✓ Global AGENTS.md        $HOME/.codex/AGENTS.md
```
