...
```markdown
Read $HOME/.codex/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "$HOME/.codex/gsd-core/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read $HOME/.codex/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read $HOME/.codex/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read $HOME/.codex/agents/gsd-eval-planner.md for instructions.
