...
```markdown
Read $HOME/.codex/agents/gsd-ui-researcher.md for instructions.
...
Template: $HOME/.codex/gsd-core/templates/UI-SPEC.md
</output>
...
```markdown
Read $HOME/.codex/agents/gsd-ui-checker.md for instructions.
