...
See $HOME/.codex/gsd-core/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using $HOME/.codex/gsd-core/templates/discovery.md structure:
...
1. **Scope the discovery** using $HOME/.codex/gsd-core/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from $HOME/.codex/gsd-core/templates/discovery.md
...
Use $HOME/.codex/gsd-core/templates/discovery.md.
