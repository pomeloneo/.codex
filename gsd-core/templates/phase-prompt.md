...
<!-- For checkpoint task examples and patterns, see @$HOME/.codex/gsd-core/references/checkpoints.md -->
...
See `$HOME/.codex/gsd-core/references/tdd.md` for TDD plan structure.
...
See `$HOME/.codex/gsd-core/templates/user-setup.md` for full schema and examples
...
See `$HOME/.codex/gsd-core/workflows/verify-phase.md` for verification logic.
